                        ...
                        <div class="detail_info">
                            ...
                            <template v-if="!fileIs(selected_file, 'folder')">
                                ...
                                <span>
                                    ...
                                    <p><a :href="selected_file.path" id="public-link" target="_blank">{{ __('voyager::generic.click_here') }}</a></p>
                                </span>
                                <span>
    ...
    Vue.component('media-manager', {
        ...
        mounted: function() {
            ...
            $(document).ready(function () {
                ...
                $('body').on('click', '#public-link', function (e) {
                    e.preventDefault();
                    ...
                    try {
                        ...
                        $(this).parent().append($('<span>', {
                            text: 'Нет SSL сертификата из-за этого нельзя скопировать ссылку!',
                            class: 'text-danger'
                        }))
                        $(this).parent().append($('<span>', {
                            text: $(this).attr('href')
