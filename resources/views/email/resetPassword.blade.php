...
<div class="email_summary"
    ...
    Восстановление пароля {{ env('APP_NAME') }}</div>
<!-- header_primary_nav -->
                            ...
                            <table class="column" role="presentation" align="center" width="100%" cellspacing="0" cellpadding="0" border="0" style="vertical-align: top;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                                ...
                                <tr>
                                    <td class="column_cell px py_md text_white text_center" style="vertical-align: top;color: #ffffff;text-align: center;padding-top: 32px;padding-bottom: 32px;padding-left: 16px;padding-right: 16px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                                        <h2 class="mt_md mb_md" style="color: #2376dc;font-family: Arial, Helvetica, sans-serif;margin-top: 32px;margin-bottom: 32px;word-break: break-word;font-size: 28px;line-height: 38px;font-weight: bold;">Восстановление пароля</h2>
                                        ...
                                        <p class="text_lead mb_md" style="color: #000;font-family: Arial, Helvetica, sans-serif;margin-top: 0px;margin-bottom: 32px;word-break: break-word;font-size: 19px;line-height: 31px;">{{ $password }}</p>
